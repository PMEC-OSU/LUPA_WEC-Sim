%% LUPA Two-Body Heave-only - Small (typical) Heave Plate 
% MULTIPHYSICSLUPA3 Experimental Campaign Spring 2024
% Same LUPA design as TEAMERLUPA2 Fall 2023 with varying heave plate
% diameters
%
...
% waves.height = 0.12;                            % [m] From Two-Body Six-DOF experiments
...
%% Body Data
%% Body 1: Float
body(1) = bodyClass('..\hydroData\floatspar_D0_9m_d2_78m.h5'); 
...
%% Body 2: Spar
body(2) = bodyClass('..\hydroData\floatspar_D0_9m_d2_78m.h5');
body(2).geometryFile = '..\geometry\LUPA_spar_D0_9m_full.stl';
...
mooring(1).location = [0 0 -0.72-0.42];      % [m] Distance in meters from the still water line down to the mooring connection point when the spar is initially displaced.
