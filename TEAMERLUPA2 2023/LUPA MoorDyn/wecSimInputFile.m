...
% waves.period = 1.75;                               % [s]  1s to 3.25s Examples of periods used for LUPA 
...
body(2).mass = 202.21;                                             % [kg] negatively buoyant 
...
pto(1).damping = 1800;                                     % [N/(m/s)] PTO Damping  Typical values fall between 0-10,000 N/(m/s)                       
