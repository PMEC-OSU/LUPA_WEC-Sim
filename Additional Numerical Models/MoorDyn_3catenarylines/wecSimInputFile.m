...
waves.height = 0.08;                            % [m] From Two-Body Six-DOF experiments
waves.period = 2.35;                               % [s]  1s to 3.25s Examples of periods used for LUPA 
...
body(2).mass = 202.21; %'equilibrium';                               % [kg] Positively bouyant spar.
...
pto(1).stiffness = 1600;                                   % [N/m] PTO Stiffness 
pto(1).damping = 3200;                                     % [N/(m/s)] PTO Damping  Typical values fall between 0-10,000 N/(m/s)                       
